<template>
    <div>
        <div class="modal fade full-width-modal-right" id="villageAdd" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" aria-labelledby="myModalLabel">
        ...
        methods:{
            ...
            confirmAdd(){   //确认提交
                ...
                if(this.complete_ok === 'ok'){
                    this.$http.post('core/house/houseSave',this.params).then((res) =>{

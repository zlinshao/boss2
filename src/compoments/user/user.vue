                                ...
                                <li v-for="(item,index) in branchList" :class="{'active':active1==index}"
                                    ...
                                    <a href="#">
                                        <button @click.stop="getSecond(item.id,item.name)"
                                                ...
                                                :disabled="item.status=='停用'">{{item.name}}
                                        </button>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <li>
                                                    <button class="btn btn-default"
                                                            @click="transferDepartment(item.id)">
                                                        调迁部门
                                                    </button>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <h4 style="color: #0f0f0f">部门
                                        <span style="color:#fff;font-size:16px;"
                                              v-if="isDepartment"> {{department}}</span>
                                    </h4>
                                </div>
                                <div class="col-lg-3 col-md-12">
                            ...
                            <table class="table table-striped table-advance table-hover">
                                ...
                                <tr v-for="item in userList">
                                    ...
                                    <td class="text-center">
                                        <router-link :to="{path:'/userDetail',query: {UserId: item.id}}">详情
                                        </router-link>
                                    </td>
                            ...
                            <div class="row pull-right" style="padding-right: 15px;">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <li>
                                            <input type="button" class="btn btn-default Previous" value="上一页"
                                                   @click="previousPage">
                                        </li>
                                        <li>
                                            <input type="button" class="btn btn-default Next" value="下一页"
                                                   @click="nextPage">
                                        </li>
                                        <li>
                                            共{{pages}}页

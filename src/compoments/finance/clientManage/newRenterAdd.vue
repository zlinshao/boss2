                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <DatePicker :dateConfigure="dateConfigure" :idName="'pendingContract'"
                                                        :currentDate="[pendingContract]" :placeholder="'待签约日期'"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <DatePicker :dateConfigure="dateConfigure" :idName="'completeDate'"
                                                        :currentDate="[complete_date]" :placeholder="'补齐时间'"

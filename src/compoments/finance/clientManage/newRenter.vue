            ...
            <div class="panel-body clearFix">
                <div v-if="pitch.length === 0">
                    <form class="form-inline clearFix" role="form">
                        ...
                        <div class="form-group" v-if="simulate.indexOf('CustomerRent/export') > -1 || isSuper">
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer text-right">
                        ...
                        <a class="btn btn-success btn-md" @click="pendTenant">确定</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            pendTenant() {
                ...
                this.$http.post('financial/pending/renter/' + this.pitch + '?uid=' + this.urlId).then((res) => {

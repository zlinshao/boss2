    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="pull-right" v-show="cus === 1">
                <router-link :to="{path:'/noPriorLease',query: { sea: seaLand, land: 1}}">
        ...
        <NoPriorLeaseAdd :list="myLandlord" @success_="getDictionary"></NoPriorLeaseAdd>
    </div>
</template>
...
<script>
    ...
    export default{
        components: {Confirm, Status, NoPriorLeaseAdd},
        data(){
            return {
                freeze: 0,
                cus: '',
...
//            修改
            reviseLand (){
                ...
                this.$http.get('finance/customer/unknown/' + this.myLandlordId).then((res) => {

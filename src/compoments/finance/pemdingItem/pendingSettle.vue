<template>
    <div>
        <div class="modal fade full-width-modal-right pendingSettle" id="pendingSettle" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="modal-body clearFix">
                            <form class="form-horizontal" role="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="type" class="form-control" v-model="pendingSellter.item_type">
                                            ...
                                            <option :value="key" v-for="(value,key) in myDictionary.item_type">
                                                {{value}}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control"
                                               v-model="pendingSellter.refund_should">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" v-model="pendingSellter.account_type">
                                            ...
                                            <option :value="key" v-for="(value,key) in myDictionary.payment">{{value}}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <SelectSubject @choose="getSubject"
                                                       :current="pendingSellter.subject_id"></SelectSubject>
                                    </div>
                                </div>
...
//            },
            receivables() {
                this.pendingSellter.refund_diff = this.refund_diff;
                this.pendingSellter.refund_real = this.refund_real;

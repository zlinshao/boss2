                    ...
                    <div class="modal-body clearFix">
                        <div class="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">打房租日期:</label>
                                <div class="col-sm-8">
                                    <input @click="remindData" type="text" name="addtime" value="" placeholder="打房租日期" class="form-control form_datetime">
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div class="panel-body has-js">
                ...
                <div v-if="pitch.length === 1" class="col-lg-12 remind">
                    <ul>
                        ...
                        <li v-if="simulate.indexOf('Customer/putInPool')>-1">
                            <h5><a @click="add_state('pool')"><i
                                    class="fa fa-users"></i>&nbsp;放入客户池</a></h5>
                        </li>
                        <li v-if="simulate.indexOf('CustomerPool/allotCustomer')>-1">
                            <h5><a @click="distribution_"><i class="fa fa-sitemap"></i>&nbsp;分配</a>
                            </h5>
                        </li>
                        <li v-if="simulate.indexOf('Customer/updateCustomer')>-1">
                ...
                <section class="panel table-responsive roll">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tr>
                            ...
                            <th class="text-center width50" v-if="simulate.indexOf('Customer/readCustomer')>-1">详情</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="list in custom_list"
                            ...
                            <td class="text-center" v-if="simulate.indexOf('Customer/readCustomer')>-1">

<template>
    <div>
        <div class="modal fade full-width-modal-right cteatePayment" id="cteatePayment" tabindex="-1" role="dialog"
                            ...
                            <form class="form-horizontal" role="form" v-if="msg!=''">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled
                                               v-model="msg.staff==undefined?'':msg.staff.real_name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled
                                               v-model="msg.department==undefined?'':msg.department.name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled
                                               v-model="msg.leader==undefined?'':msg.leader.real_name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled
                                               v-model="msg.customer==undefined?'':msg.customer.name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" disabled
                                               v-model="msg.house==undefined?'':msg.house.detailed_address">
                                    </div>
                                </div>
                                ...
                                <div v-if="from!=3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <SelectSubject @choose="getSubject2"
                                                           :current="money[1].subject_id"></SelectSubject>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <!--<label class="col-sm-2 control-label">款项科目</label>-->
                                        <div class="col-sm-10">
                                            <SelectSubject @choose="getSubject1"
                                                           :current="money[0].subject_id"></SelectSubject>
                                        </div>
                                    ...
                                    <div class="form-group" v-if="msg.cost_medi !== '0.00'">
                                        ...
                                        <!--<label class="col-sm-2 control-label">款项科目</label>-->
                                        <div class="col-sm-10">
                                            <SelectSubject @choose="getSubject3"
                                                           :current="money[2].subject_id"></SelectSubject>
                                        </div>
                                    </div>
                                    <!--<div class="form-group">-->
                                    <!--<label class="col-sm-2 control-label">其他款项</label>-->
                                    <!--&lt;!&ndash;<div class="col-sm-3">&ndash;&gt;-->
                                    <!--&lt;!&ndash;<select class="form-control" v-model="money[3].money_name">&ndash;&gt;-->
                                    <!--&lt;!&ndash;<option :value="value" v-for="(key,value) in money_name">{{key}}</option>&ndash;&gt;-->
                                    <!--&lt;!&ndash;</select>&ndash;&gt;-->
                                    <!--&lt;!&ndash;</div>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<label class="col-sm-2 control-label">款项科目</label>&ndash;&gt;-->
                                    <!--<div class="col-sm-10">-->
                                    <!--<SelectSubject @choose="getSubject4"-->
                                    <!--:current="money[3].subject_id"></SelectSubject>-->
                                    <!--</div>-->
                                    <!--</div>-->
                                ...
                                <div v-if="from == 3">
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">款项科目</label>
                                        <div class="col-sm-4">
                                            <SelectSubject @choose="getSubject7"
                                                           :current="otherSubject"></SelectSubject>
                                        </div>
                                    </div>
                                </div>

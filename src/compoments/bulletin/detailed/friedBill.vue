                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body roll">
                        <div v-for="(key,index) in data" class="clearfix history">
                            ...
                            <div class="form-group col-sm-6" style="padding: 0" v-if="title == '款项详情'">
                            ...
                            <div class="form-group col-sm-6" style="padding: 0">
                                ...
                                <label class="col-sm-4 control-label" v-if="title == '调房详情'"
                                       style="width: 41%">原签约时长：</label>
                            ...
                            <div class="form-group col-sm-6" style="padding: 0">
                                ...
                                <label class="col-sm-4 control-label" v-if="title == '调房详情'"
                                       style="width: 41%">原定金/全款：</label>
                                <div class="col-lg-8">{{staff_name}}</div>
                            </div>

                            <!--调房详情-->
                            <div class="form-group col-xs-12" style="padding: 0" v-if="title == '调房详情'">
                            ...
                            <div class="form-group col-sm-6" style="padding: 0" v-if="title == '调房详情'">

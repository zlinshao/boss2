            ...
            <div class="panel-body has-js">
                <div v-if="contractSeleted.length === 0">
                    <div v-if="flag">
                        ...
                        <div class="pull-right" style="margin: 8px">
                            ...
                            <button class="btn btn-primary" @click="collectAdd" v-show="simulate.indexOf('Rent/saveContract') > -1">
                                <i class="fa fa-plus-square"></i>&nbsp;新增租房合同
                            </button>
                        </div>
                ...
                <div class="panel-body" v-if="contractSeleted.length > 0" style="padding: 0;">
                    <ul>
                        ...
                        <li class="operate" v-if="contractSeleted.length ===1&&simulate.indexOf('Rent/mark') > -1">
                        ...
                        <li class="operate" v-if="contractSeleted.length ===1&&simulate.indexOf('Rent/delete') > -1">
                        <!--<li class="operate" v-if="contractSeleted.length ===1">-->
                        ...
                        <li class="operate" v-if="contractSeleted.length ===1&&simulate.indexOf('Rent/readContract_review') > -1">
                        <!--<li class="operate" v-if="contractSeleted.length ===1">-->
                            <router-link tag="i" class="fa fa-eye" :to="{path:'/rentingDetail',
                                query: {ContractId: contractSeleted,flag:'review'}}">查看回访记录
                            </router-link>
                        </li>
                        <li class="operate" @click="distribution" v-if="simulate.indexOf('MoveOrder/moveOrder_rent') > -1">
                            <i class="fa fa-sitemap">按人员分配</i>&nbsp;
                        </li>
                        <li class="operate" @click="distributionDpm" v-if="simulate.indexOf('MoveOrder/moveOrderByDpm_rent') > -1">

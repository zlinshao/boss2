            ...
            <div class="panel-body has-js">
                <div v-if="contractSeleted.length === 0">
                    <div v-if="flag">
                        ...
                        <div class="pro-sort" v-if="simulate.indexOf('Rent/contractList_all')>-1||isSuper">
                            <label>
                ...
                <div class="panel-body" v-if="contractSeleted.length > 0" style="padding: 0;">
                    <ul>
                        ...
                        <!--<li class="operate" v-if="contractSeleted.length ===1&&(simulate.indexOf('Rent/mark') > -1||isSuper)">
                        ...
                        <li class="operate" v-if="simulate.indexOf('MoveOrder/stopContract_rent') > -1&&contractStatus[0] !=1&& contractSeleted.length ===1">

            ...
            <div class="col-md-4 col-sm-5 col-xs-6 content" v-if="collectContractList !==[]">
                <div class="contract_detail"  v-for="item in collectContractList">
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.checkin_collect_id !== null && item.checkin_collect_id !== undefined">{{item.checkin_collect_id.years}}年</span>
                    </div>
                    ...
                    <div class="infoList">
                        <span>开户行：</span>
                        <span v-if="item.checkin_collect_id !== null && item.checkin_collect_id !== undefined">{{myDictionary.bank[item.checkin_collect_id.bank]}}</span>
                    </div>
                    <div class="infoList">
                        <span>银行卡号：</span>
                        <span v-if="item.checkin_collect_id !== null && item.checkin_collect_id !== undefined">{{item.checkin_collect_id.account}}</span>
                    </div>
                    <div class="infoList">
                        <span>中介费用：</span>
                        <span v-if="item.checkin_collect_id !== null && item.checkin_collect_id !== undefined">{{item.checkin_collect_id.cost_medi}}</span>
                    </div>
                    <div class="infoList">
                        <span>资料补齐日期：</span>
                        <span>
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{item.customer_id.name}}</span>
                    </div>
                    <div class="infoList">
                        <span>尊称<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{myDictionary.gender[item.customer_id.gender]}}</span>
                    </div>
                    <div class="infoList">
                        <span>国籍<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">
                            {{myDictionary.nationality[item.customer_id.nationality]}}
                        </span>
                    </div>
                    <div class="infoList">
                        <span>手机号码<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{item.customer_id.mobile}}</span>
                    </div>
                    <div class="infoList">
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{item.customer_id.id_num}}</span>
                    </div>
                    <h4>房屋信息</h4>
                    <div class="infoList ">
                        <span >房屋地址：</span>
            ...
            <div class="col-md-4 col-sm-5 col-xs-6 " v-if="rentContractList !== []">
                <div class="contract_detail"  v-for="item in rentContractList">
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.checkin_rent_id !==null && item.checkin_rent_id !== undefined">{{item.checkin_rent_id.months}} 月</span>
                    </div>
                    <div class="infoList">
                        <span>合同起始日期：</span>
                        <span>{{item.start_date}}</span>
                    ...
                    <div class="infoList" v-if="item.checkin_rent_id !==null && item.checkin_rent_id !== undefined && undefined">
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{myDictionary.person_medium[item.customer_id.person_medium]}}</span>
                    </div>
                    <div class="infoList">
                        <span>中介费用：</span>
                        <span  v-if="item.checkin_rent_id !==null && item.checkin_rent_id !== undefined">
                    ...
                    <div class="infoList">
                        <span>国籍<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{myDictionary.nationality[item.customer_id.nationality]}}</span>
                    </div>
                    <div class="infoList">
                        <span>手机号码<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{item.customer_id.mobile}}</span>
                    ...
                    <div class="infoList">
                        <span>证件类型<sup>*</sup>：</span>.
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{myDictionary.credentials[item.customer_id.id_type]}}</span>
                    </div>
                    <div class="infoList">
                        <span>身份证号<sup>*</sup>：</span>
                        <span v-if="item.customer_id !== null && item.customer_id !== undefined">{{item.customer_id.id_num}}</span>

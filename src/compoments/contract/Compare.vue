            ...
            <div class="col-md-4 col-sm-5 col-xs-6 content" v-if="collectContractList !==[]">
                <div class="contract_detail"  v-for="item in collectContractList">
                    ...
                    <div class="infoList">
                        <span>开户行：</span>
                        <span v-if="item.checkin_collect_id !== null && item.checkin_collect_id !==undefined">
                            {{myDictionary.bank[item.checkin_collect_id.bank]}}
                        </span>
                    </div>
                    <div class="infoList">
                        <span>银行卡号：</span>
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.customer_id !== null && item.customer_id !==undefined">
                            {{myDictionary.gender[item.customer_id.gender]}}
                        </span>
                    </div>
                    <div class="infoList">
            ...
            <div class="col-md-4 col-sm-5 col-xs-6 " v-if="rentContractList !== []">
                <div class="contract_detail"  v-for="item in rentContractList">
                    ...
                    <div class="infoList">
                        ...
                        <span v-if="item.customer_id !== null && item.customer_id !==undefined">
                            {{myDictionary.person_medium[item.customer_id.person_medium]}}
                        </span>
                    </div>
                    <div class="infoList">
                        <span>中介费用：</span>

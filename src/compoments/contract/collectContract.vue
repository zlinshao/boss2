<template>
    <div>
            ...
            <div class="panel-body has-js">
                ...
                <div class="panel-body" v-if="contractSeleted.length > 0" style="padding: 0;">
                    <ul>
                        ...
                        <li class="operate" @click="showSendMail" v-if="simulate.indexOf('Collect/sendSms')>-1||isSuper">
        ...
        <h4 style="margin-top: 50px" v-show="simulate.indexOf('OldCollect/searchFuserIndex') > -1||isSuper">老系统数据</h4>
        <!--表格-->
        <div v-show="simulate.indexOf('OldCollect/searchFuserIndex') > -1||isSuper">
            <section class="panel table table-responsive roll">
                <table class="table table-striped table-advance table-hover">
                    <thead class="text-center">
                    <tr>
...
//                    console.log(res.data);
            ...
            searchOldContract(){
                if(this.contractSearchInfo.keywords){
                    this.$http.get('old/collect?input='+ this.contractSearchInfo.keywords+'&page='+this.oldPage).then((res) => {
            ...
            sign(id,mark){
                this.$http.put('old/collect/rep/'+id+'?newmark='+mark).then((res) => {
                    if(res.data.code === '80010'){
                        this.searchOldContract();
                        this.info.success = res.data.msg;
                        //显示成功弹窗 ***

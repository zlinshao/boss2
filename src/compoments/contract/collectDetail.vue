    ...
    <div>
        ...
        <div class="title clearFix">
            ...
            <div class="pull-right dropdown" v-for="item in contractList">
                ...
                <router-link class="btn btn-primary" :to="{path:'/comparecontract',query:{houseId : houseId}}" v-show="simulate.indexOf('Collect/Rent/compare')>-1">
                    对比
                </router-link>
                <button class="btn btn-primary" @click="inform" v-if="contract_status!=1&&simulate.indexOf('Collect/inform')>-1">通知</button>
                ...
                <button class="btn btn-primary" @click="passContract" v-if="contract_status!=1&&simulate.indexOf('ContractCheck/checkContract_collect')>-1"
                        :disabled = " contract_pass===5 || contract_pass===1">
                    {{dictionary.passed_submit[contract_pass]}}
                </button>
                <button class="btn btn-warning" v-if="contract_pass > 2 && contract_status!=1&&simulate.indexOf('ContractCheck/reject_collect')>-1" @click='overrule'>驳回</button>
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li v-if="simulate.indexOf('Collect/updateContract')>-1">
                            <button class="btn btn-white btn-block" @click="editContract"
                                    :disabled="(contract_pass>4||contract_status==1) && simulate.indexOf('Collect/update_success') == -1" >
                                编辑
                            </button>
                        </li>
                        <li v-show="simulate.indexOf('Collect/continued')>-1">
                            <button class="btn btn-white btn-block" @click="renewContract" :disabled="contract_status==1">
                                续约
                            </button>
                        </li>
                        <li v-show="simulate.indexOf('Collect/readContract_easy')>-1">
                                    ...
                                    <div class="infoContainer">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="infoList clearFix">
                                                ...
                                                <span class="col-lg-10" v-if="item.villa_id !==null && item.villa_id !==undefined">

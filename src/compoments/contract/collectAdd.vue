                            ...
                            <div class="panel-body">
                                <form class="form-horizontal tasi-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" @click="changeisClick" v-model="contractAdd.months">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-9" @click="changeisClick">
                                            <DatePicker :dateConfigure="dateConfigure" :idName="'startVac'" :placeholder="'点击选择时间'"
                                                        :currentDate="[contractAdd.vac_start_date]"  @sendDate="getVacStart"></DatePicker>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-9" @click="changeisClick">
                                            <DatePicker :dateConfigure="dateConfigure" :idName="'endVac'" :placeholder="'点击选择时间'"
                                                        :currentDate="[contractAdd.vac_end_date]"  @sendDate="getVacEnd"></DatePicker>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <label v-show="contractAdd.payment==1" class="col-sm-2 control-label">账号</label>
                                            <label v-show="contractAdd.payment==2" class="col-sm-2 control-label">支付宝账号</label>
                                            <label v-show="contractAdd.payment==3" class="col-sm-2 control-label">微信账号</label>
                                            <label v-show="contractAdd.payment==4" class="col-sm-2 control-label">存折账号</label>
...
//                    is_medi : 1,
        ...
        methods : {
            ...
            completeDate(val,oldVal,flag){  //计算空置期结束 合同开始以及结束时间
                if(flag === 'start' && val > this.contractAdd.vac_end_date && this.contractAdd.vac_end_date !== ''){
                    this.contractAdd.vac_start_date = oldVal;
                    this.info.error = '开始日期必须小于结束日期';
                    this.info.state_error = true;
                }else if(flag === 'end' && val < this.contractAdd.vac_start_date && this.contractAdd.vac_start_date !== ''){
                ...
                this.$http.post('core/collect/date',
                    {
                        ...
                        vac_end_date : this.contractAdd.vac_end_date,
                        months : this.contractAdd.months,
                    }).then(
                    (res) => {
                        if(res.data.code === '70010'){
                            this.contractAdd.start_date = res.data.data.start_date;
            ...
            getVacEnd(val){
                this.contractAdd.vac_end_date = val;
            },
            getDate1(val){

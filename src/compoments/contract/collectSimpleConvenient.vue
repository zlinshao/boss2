<template>
    <div>
        ...
        <div class="modal fade full-width-modal-right" id="collectSimpleConvenient" tabindex="-1" role="dialog" data-backdrop="static"
                    ...
                    <div class="modal-body">
                        <div class="table table-responsive">
                            <section class="panel infoContainer" v-for="item in contractList">
                                ...
                                <div class="infoList">
                                    <span>证件照片：</span>
                                    <span v-if="item.customer_id.album.id_pic !==undefined">
                                ...
                                <div class="infoList">
                                    <span>银行卡：</span>
                                    <span  v-if="item.album.bank_pic !==undefined">
                                ...
                                <div class="infoList">
                                    ...
                                    <span >
                                        <img :src="img.small" @click="showLargePic('water_card_pic',index)"
                                             v-for="(img,index) in item.album.water_card_pic"></span>
                                </div>
                                <div class="infoList">
                                    <span>电费照片：</span>
                                    <span>

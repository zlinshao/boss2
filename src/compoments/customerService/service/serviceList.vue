                ...
                <section class="panel table table-responsive roll">
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tr class="text-center" v-for="item in myData">
                            ...
                            <td>
                                <router-link :to="{path:'/serviceDetail',query:{id:item.process_instance_id,page:beforePage,myParams:params,select:selected}}">详情</router-link>
                            </td>
                        </tr>
...
//            获取列表
            getList(val){
                ...
                this.params.code = 'PROC-HFMKHA3W-YAOONFLURGASGWPGSGKV1-JWV1K18J-2';
